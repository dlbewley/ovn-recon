...
- [ ] Render actual YAML content inline (fetch from API or reuse existing console YAML view).
...
- [ ] Add a notion of gravity that can be used to sort graph nodes in a column.